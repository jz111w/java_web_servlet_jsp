								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" id=""
											value="${requestScope.user.password }" size="85"
											name="password" class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>电子邮件：</th>
										<td><input type="text" id=""
											value="${requestScope.user.email }" size="85" name="email"
