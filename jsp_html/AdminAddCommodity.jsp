							...
							<table width="100%" class="insert-tab">
								<tbody>
									<tr>
										...
										<td><input type="text" id="" size="85" name="id"
											class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>价格：</th>
										<td><input type="text" id="" size="85" name="price"
											class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>名称：</th>
										<td><input type="text" id="" size="85" name="name"
											class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>类型：</th>
										<td><input type="text" id="" size="85" name="type"
											class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>品牌：</th>
										<td><input type="text" id="" size="85" name="brand"
											class="common-text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>图片：</th>
										<td><input type="text" id="" size="85" name="image"
											class="common-text"></td>
									</tr>
