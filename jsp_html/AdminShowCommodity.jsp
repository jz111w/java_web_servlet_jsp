...
<body>
	<%
		int count = 0;
	ArrayList<Commodity> aa = (ArrayList<Commodity>) application.getAttribute("aalllist");
	%>
				...
				<form name="myform" id="myform" method="post">
					<div class="result-title">
						<div class="result-list">
							<a href="./AdminAddCommodity.jsp"><i class="icon-font"></i>新增商品</a>
						</div>
					</div>
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<c:forEach var="i" items="${aalllist}">
								<tr>
									<%
										count += 1;
									%>
									...
									<td><a class="link-update"
										href="./aucc?iddd=${i.id}">修改</a> <a class="link-del"
										href="./adcm?idadc=${i.id} ">删除</a></td>
								</tr>
							</c:forEach>
						</table>
						<div class="list-page">
