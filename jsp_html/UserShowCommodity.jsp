...
<body>
	<%
		int count = 0;
	ArrayList<Commodity> list = (ArrayList<Commodity>) application.getAttribute("list");
	String userid = (String) application.getAttribute("uuu");
	String a=(String)application.getAttribute("brand");
	%>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i>首页<span
						class="crumb-step">&gt;</span><span class="crumb-name">全部商品：</span>
						<span
						class="crumb-step">&gt;</span><span class="crumb-name"><%=a %></span>
				</div>
			</div>
			<div class="search-wrap">
				<div class="search-content">
					<form action="./ubo" method="post">
						<table class="search-tab">
							<tr>
								<th width="120">选择品牌:</th>
								<td><select name="brandsort">
										<option value="0">全部品牌</option>
										<option value="1">罗技</option>
										<option value="2">cherry</option>
										<option value="3">ikbc</option>
										<option value="4">Varmilo</option>
								</select></td>
						...
						<table class="result-tab" width="100%">
							...
							<c:forEach var="i" items="${list}">
								<tr>
									...
									<td>${i.type}</td>
									<td>${i.price}</td>
									<td><a class="./uas" href="./uas?ide=${i.id}&price=${i.price}">添加购物车</a></td>
								</tr>
							</c:forEach>
						</table>
						<div class="list-page">
